...
router.route("/verify/:filename").get(verificationPdf); //to be used in dashboard, when verify button in each dashboard is clicked verified value will be updated with: 'dean', 'student', 'tutor', 'principal', value of verified is updated based on which type of user(role) is logged in
